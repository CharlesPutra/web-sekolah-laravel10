        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kepalasekolah.update', $edit->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" id="nama"
                                    ...
                                    value="{{ old('nama',$edit->nama) }}" placeholder="Masukkan nama">
                                @error('nama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="ucapan" id="ucapan" class="form-control @error('ucapan') is-invalid @enderror" rows="4"
                                    placeholder="Tulis ucapan juara">{{ old('ucapan',$edit->ucapan) }}</textarea>
                                @error('ucapan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
