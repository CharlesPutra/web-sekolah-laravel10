                        ...
                        <form action="{{ route('infrastruktur.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.001" min="0" name="luas_tanah" id="luas_tanah"
                                    ...
                                    value="{{ old('luas_tanah') }}" placeholder="Masukkan luas_tanah">
                                @error('luas_tanah')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number"  name="ruang_kelas" id="ruang_kelas"
                                    ...
                                    value="{{ old('ruang_kelas') }}" placeholder="Masukkan ruang_kelas">
                                @error('ruang_kelas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number"  name="lab_komputer" id="lab_komputer"
                                    ...
                                    value="{{ old('lab_komputer') }}" placeholder="Masukkan lab_komputer">
                                @error('lab_komputer')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number"  name="perpustakaan" id="perpustakaan"
                                    ...
                                    value="{{ old('perpustakaan') }}" placeholder="Masukkan perpustakaan">
                                @error('perpustakaan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
