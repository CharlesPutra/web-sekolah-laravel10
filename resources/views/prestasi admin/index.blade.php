    ...
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold text-dark">
                <i class="bi bi-list-ul me-2 text-primary"></i>Daftar Kejuaraan
            </h2>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card h-100 border-0 shadow-sm card-hover">
                        ...
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title fw-bold">{{ $data->juara }}</h5>
                        ...
                        <div class="card-footer bg-white d-flex justify-content-between border-0">
                            <a href="{{ route('prestasi.edit', $data->id) }}" class="btn btn-sm btn-outline-warning">
