          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item active" data-bs-interval="2000">
              <div class="card shadow border-0 rounded-4">
                <img src="{{ asset('images/prestasi1.png') }}" class="card-img-top rounded-top-4" alt="Prestasi 1" style="max-width: 200px; margin:auto;">
                <div class="card-body">
                  <h5 class="fw-bold">Juara 2 Lomba Content Creator Tingkat SMK Swasta Kabupaten Banyuwangi</h5>
                  <p class="text-muted">Selamat kepada HANUM SYAFIRA MURTI siswi XI Akuntansi Keuangan Lembaga SMK 17 Agustus 1945 Muncar.</p>
                </div>
              </div>
            </div>
            ...
            <div class="carousel-item" data-bs-interval="2000">
              <div class="card shadow border-0 rounded-4">
                <img src="{{ asset('images/prestasi2.jpg') }}" class="card-img-top rounded-top-4" alt="Prestasi 2" style="max-width: 200px; margin:auto;">
                <div class="card-body">
                  <h5 class="fw-bold">Juara 2 Lomba Content Creator Tingkat SMK Swasta Kabupaten Banyuwangi</h5>
                  <p class="text-muted">Selamat kepada DENIS PRAYOGA siswa XI Perhotelan SMK 17 Agustus 1945 Muncar.</p>
                </div>
              </div>
            </div>
            ...
            <div class="carousel-item"  data-bs-interval="2000">
              <div class="card shadow border-0 rounded-4">
                <img src="{{ asset('images/prestasi3.png') }}" class="card-img-top rounded-top-4" alt="Prestasi 3" style="max-width: 200px; margin:auto;">
                <div class="card-body">
                  <h5 class="fw-bold">Juara 2 dalam "LKS Rekayasa Perangkat Lunak"</h5>
                  <p class="text-muted">Selamat kepada CHARLES AGUSTIAN PUTRA, siswa XI RPL SMK 17 Agustus 1945 Muncar.</p>
                </div>
              </div>
            </div> 
                ...
                <div id="ekstraCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                          <div class="card shadow-sm border-0 mx-auto" style="width: 300px; height: 350px; border-radius: 15px;">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center h-100">
                              <img src="{{ asset('images/ekstra/osis.png') }}" alt="OSIS" style="max-width:180px; max-height:200px; object-fit:contain;">
                        ...
                        <div class="carousel-item">
                          <div class="card shadow-sm border-0 mx-auto" style="width: 300px; height: 350px; border-radius: 15px;">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center h-100">
                              <img src="{{ asset('images/ekstra/Da.png') }}" alt="Pramuka" style="max-width:180px; max-height:200px; object-fit:contain;">
      ...
      <div class="col-md-4" data-aos="zoom-in">
        <div class="card shadow-sm h-100 border-0">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Deskripsi singkat berita pertama yang menarik perhatian pembaca.</p>
...
<svg class="wave-bottom" xmlns="http://www.w3.org/2000/svg" 
