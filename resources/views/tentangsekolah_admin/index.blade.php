...
<div class="container my-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark">
            <i class="bi bi-list-ul me-2 text-primary"></i> Daftar Tentang Sekolah
        </h2>
        <a href="{{ route('tentangsekolah.create') }}" class="btn btn-primary shadow-sm">
            ...
            <tbody>
                @forelse ($datas as $index => $data)
                    <tr>
                        ...
                        <td class="fw-bold">{{ $data->tentang_sekolah }}</td>
                        <td>
                            <a href="{{ route('tentangsekolah.edit', $data->id) }}" 
